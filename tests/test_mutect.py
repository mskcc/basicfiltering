...
def main():
    ...
    outFileVcf = os.path.join(this_dir, "PoolTumor2-T_bc52_muTect_1.1.4_STDfilter.vcf")
    outFileTxt = os.path.join(this_dir, "PoolTumor2-T_bc52_muTect_1.1.4_STDfilter.txt")
