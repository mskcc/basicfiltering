...
def main():
    ...
    outFileVcf = os.path.join(this_dir, "PoolTumor2-T_bc52_PINDEL_0.2.5a7_STDfilter.vcf")
    outFileTxt = os.path.join(this_dir, "PoolTumor2-T_bc52_PINDEL_0.2.5a7_STDfilter.txt")
